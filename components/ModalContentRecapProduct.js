...
import {ActivityIndicator, Alert, FlatList, Image, Platform, ScrollView, Text, View} from "react-native";
    ...
    return (
        <ScrollView>
            ...
            <ActionContainer>
                {
                    isLoading ?
                        <ActivityIndicator size="large" color="#33efad" />
                        :
                        <ContainerButton
                            onPress={() => {
                                setIsLoading(true);
                                handleSubmitAddProduct().finally(() => setIsLoading(false));
                            }}
                        >
